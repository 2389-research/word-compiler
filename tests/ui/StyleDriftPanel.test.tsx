...
import { StyleDriftPanel } from "../../src/app/components/StyleDriftPanel.js";
...
describe("StyleDriftPanel", () => {
  ...
  it("renders baseline scene title", () => {
    ...
    render(<StyleDriftPanel reports={reports} baselineSceneTitle="Opening Scene" />);
  ...
  it("shows OK status for non-flagged report", () => {
    ...
    render(<StyleDriftPanel reports={reports} baselineSceneTitle="Scene 1" />);
